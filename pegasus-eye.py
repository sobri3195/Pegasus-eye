...
\______   \ ____   _________    ________ __  ______ \_   _____/__.__. ____  
 |     ___// __ \ / ___\__  \  /  ___/  |  \/  ___/  |    __)<   |  |/ __ \ 
 |    |   \  ___// /_/  > __ \_\___ \|  |  /\___ \   |        \___  \  ___/ 
 |____|    \___  >___  (____  /____  >____//____  > /_______  / ____|\___  >
               \/_____/     \/     \/           \/          \/\/         \/                                                                                                                       
...
@author dr.Muhammad Sobri Maulana, CEH, OSCP <http://dohamupretoragean.ga/>
...
PegasusEye_BANNER = 'Pegasus Eye <www.dohamupretoragean.ga>'
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print "{0} PegasusEye strikes deferred. ({1} Failed)".format(self.counter[0], self.counter[1])
...
def usage():
    ...
    print PegasusEye_BANNER
    print 
    print ' USAGE: ./PegasusEye.py <url> [OPTIONS]'
    print
    print ' OPTIONS:'
...
def main():
    ...
    try:
        ...
        PegasusEye = PegasusEye(url)
        PegasusEye.useragents = useragents
        PegasusEye.nr_workers = workers
        PegasusEye.method = method
        PegasusEye.nr_sockets = socks
